...
class TestActionGenerator(TestCase):
    ...
    def test_generate_without_commission(self):
        ...
        cum_gains, actions, advantages = generator.generate(prices)
        ...
        self.check_matrix_equal([[2, 2, 1, 1.05, 2, 2, 1], [2, 2, 1, 1.05, 2, 2, 1]], advantages, 2)
    ...
    def test_generate_with_commission(self):
        ...
        self.check_matrix_equal([[2, 2, 1, 1.05, 2, 1.82, 1], [2.44, 2.44, 1.22, 1.16, 2.44, 2.22, 1]], advantages, 2)
    ...
    def check_list_equal(self, list1, list2, places):
        ...
        for i in range(len(list1)):
            self.assertAlmostEqual(list1[i], list1[i], places)
