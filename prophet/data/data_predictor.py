...
class DataPredictor:
    ...
    def __fit_model(self, train_dataset, train_size, test_dataset, test_size,
        ...
        train_dataset = train_dataset.shuffle(train_size, reshuffle_each_iteration=True).batch(batch_size)
        test_dataset = test_dataset.shuffle(test_size, reshuffle_each_iteration=True).batch(batch_size)
